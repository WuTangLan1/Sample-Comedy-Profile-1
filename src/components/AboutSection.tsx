...
const AboutSection = forwardRef<HTMLElement>((_, ref) => {
  return (
    <section ref={ref} id="about" className="min-h-screen relative flex flex-col items-center justify-center bg-gray-100 bg-opacity-30 backdrop-filter backdrop-blur-md bg-[url('/images/backgrounds/aboutbg.svg')] bg-cover bg-center">
      ...
      <div className="relative container mx-auto p-8 bg-white/20 rounded-xl shadow-lg flex flex-col md:flex-row items-center max-w-full">
        <div className="w-full md:w-1/2 p-4 flex justify-center">
          <img src="/images/profile_photos/profile5.png" alt="Profile" className="w-64 h-64 object-cover rounded-full border-4 border-white shadow-xl" />
        </div>
      ...
      <div className="relative container mx-auto p-8 mt-12 bg-black/30 rounded-xl shadow-2xl flex flex-col md:flex-row items-center max-w-full">
        <div className="w-full md:w-1/2 p-4">
          <img src="/images/event_photos/event1.png" alt="Event 1" className="w-full h-auto rounded-lg shadow-lg" />
        </div>
      ...
      <div className="relative container mx-auto p-8 mt-12 bg-black/30 rounded-xl shadow-2xl flex flex-col md:flex-row-reverse items-center max-w-full">
        <div className="w-full md:w-1/2 p-4">
          <img src="/images/event_photos/event2.png" alt="Event 2" className="w-full h-auto rounded-lg shadow-lg" />
        </div>
        <div className="w-full md:w-1/2 p-4 text-white">
      ...
      <div className="relative container mx-auto p-8 mt-12 bg-black/30 rounded-xl shadow-2xl flex flex-col md:flex-row items-center max-w-full">
        <div className="w-full md:w-1/2 p-4">
          <img src="/images/profile_photos/profile1.png" alt="Profile" className="w-full h-auto rounded-lg shadow-lg" />
        </div>
        <div className="w-full md:w-1/2 p-4 text-white">
